...
function Header() {
	...
	document.addEventListener('scroll', (event) => {
		...
		if (
			window.pageYOffset >
			document.getElementsByClassName('header-div-1')[0].getBoundingClientRect().height
		) {
			setIsActive(true);
		} else {
			setIsActive(false);
	...
	return (
		<header style={{ display: 'inline' }}>
			<div className={isActive ? 'header-div-1 header-top-margin' : 'header-div-1'}>
										...
										<label className="header-li-label">
											<a href="" className="header-li-anchor">
												...
												<div className="header-li-arrow-div">
													<svg viewBox="0 0 12 7" fill="none" className="header-li-arrow-svg">
										...
										<div className="header-dropdown-div">
											<ul className="header-dropdown-list">
												<li className="header-dropdown-listitem">
													<a href="" className="header-dropdown-listitem-anchor">
														All
													</a>
												</li>
												<li className="header-dropdown-listitem">
											...
											<div className="qwert-div">
												...
												<ul className="qwert-ul">
													{Categories.map((listitem) => {
														return <HeaderCategoryLi key={listitem.id} name={listitem.name} />;
													})}
												</ul>
											</div>
											<div className="qwert-div">
												<label className="qwert-label">Featured collections</label>
												<ul className="qwert-ul">
									...
									<li className="header-nav-profile-li">
										<label className="header-nav-profile-li-label">
											<div className="header-nav-profile-li-label-div">
												<span className="header-nav-profile-li-label-div-span-1">Paresh</span>
												...
												<ul className="header-nav-profileinfo-ul">
													...
													<li className="header-nav-profileinfo-ul-li add-button">
														<a href="">
															...
															<span className="header-nav-add-profile-span-2">Add new</span>
														</a>
													</li>
													<li className="header-nav-profileinfo-ul-li">
